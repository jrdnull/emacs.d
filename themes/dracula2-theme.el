;;; dracula2-theme.el --- Dracula Theme
...
;; Modified from original theme dracula by film42
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(fringe ((,class (:foreground ,bg4 :background ,bg1))))
...
(provide-theme 'dracula2)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; dracula2-theme.el ends here
